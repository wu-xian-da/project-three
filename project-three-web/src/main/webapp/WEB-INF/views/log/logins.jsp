...
<body>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
           <c:forEach items="${button_id}" var="b">
            <c:if test="${b.buttons == '[logins:select]'}">
	...
	<table width="1200px;" style="font-size: 8px;" class="td">
		...
		<!-- 上一页 -->
		<td width="50px;">
		<a id="shangyiye" href="${pageContext.request.contextPath}/log/logins?pn=${bianPageShang}${loginsurl}&ps=${page.pageSize}&roleId=<%=roleid%>">上一页
		...
		<!-- 下一页 -->
		<td width="50px;">
		<a id="xiayiye" href="${pageContext.request.contextPath}/log/logins?pn=${bianPageXia}${loginsurl}&ps=${page.pageSize}&roleId=<%=roleid%>">
